...
We use a garden heatmap function `heatmap.function` after [obigriffith's heatmap.function](https://raw.githubusercontent.com/obigriffith/biostar-tutorials/master/Heatmaps/heatmap.function.R).
...
Here is an example with few parameters. 
...
heatmap.function(mat, RowSideColors=row_annotation, ColSideColors=column_annotation)
...
par(cex.main=1)
heatmap.function(plant_abundance, hclustfun=myclust, distfun=mydist, na.rm = TRUE, scale="none", dendrogram="both", margins=c(6,12),
          ...
          ColSideColorsSize=7, RowSideColorsSize=2, KeyValueName="Plant density")
